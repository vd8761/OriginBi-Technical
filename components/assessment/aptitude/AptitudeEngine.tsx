        ...
        <div className="min-h-screen w-full bg-brand-light-primary dark:bg-brand-dark-primary flex flex-col font-sans transition-colors duration-500">
            ...
            <main className="flex-1 flex flex-col lg:flex-row overflow-hidden relative h-[calc(100vh-120px)]">
                ...
                <div className="flex-1 flex flex-col overflow-y-auto custom-scrollbar p-4 md:p-6 relative">
                    ...
                    {/* Question Text */}
                    <div className="bg-white dark:bg-[#1A1D21] border border-brand-light-tertiary dark:border-white/5 p-5 md:p-8 rounded-[20px] shadow-sm mb-6 transition-colors">
                        <h2 className="text-[clamp(14px,1.2vw,18px)] font-semibold text-brand-text-light-primary dark:text-white leading-relaxed">
            ...
            {/* Bottom Action Bar */}
            <footer className="h-16 md:h-20 border-t border-brand-light-tertiary dark:border-white/5 bg-white dark:bg-[#1A1D21] p-4 flex flex-wrap gap-3 items-center justify-between sticky bottom-0 z-50">
                <div className="flex items-center gap-2 w-full sm:w-auto">
                    <button 
                        onClick={handleMarkReview}
                        className={`flex-1 sm:flex-none px-5 py-2.5 rounded-full border font-bold text-[12px] transition-all ${markedForReview.has(currentQuestion.id) ? 'bg-amber-500/10 border-amber-500 text-amber-600 dark:text-amber-500' : 'bg-white dark:bg-[#24272B] border-brand-light-tertiary dark:border-white/20 text-brand-text-light-primary dark:text-white hover:bg-black/5 dark:hover:bg-white/5'}`}
                    >
                    ...
                    <button 
                        ...
                        className="flex-1 sm:flex-none px-5 py-2.5 rounded-full bg-white dark:bg-[#24272B] border border-brand-light-tertiary dark:border-white/20 text-brand-text-light-primary dark:text-white font-bold text-[12px] hover:bg-black/5 dark:hover:bg-white/5 transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                    >
                        Clear Response
                    </button>
                </div>
