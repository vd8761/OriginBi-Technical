        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)]">
            <section className="rounded-lg border border-brand-green/10 bg-brand-green/[0.03] p-4 dark:border-white/10 dark:bg-white/5">
                <div className="mb-4 flex items-center justify-between gap-3">
                    <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-[#17201b] dark:text-white">
                ...
                <div className="custom-scrollbar max-h-[460px] overflow-y-auto rounded-lg border border-brand-green/10 bg-white p-4 dark:border-white/10 dark:bg-[#0f1712]">
                    <p className="text-sm font-medium leading-7 text-[#17201b] dark:text-white">
                        {formattedPassage}
                    </p>
                </div>
            </section>
            ...
            <section className="flex flex-col gap-4">
                {task.questions.map((question, qIndex) => (
                    <div key={question.id} className="rounded-lg border border-brand-green/10 bg-white p-4 dark:border-white/10 dark:bg-[#0f1712]">
