...
const checklist = [
    ...
    "There is no negative marking in this assessment.",
                ...
                <header className="flex items-start justify-between gap-4 border-b border-slate-100 p-5 sm:p-6 dark:border-white/10">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <h2 id="role-pretest-title" className="mt-1 text-2xl font-extrabold leading-tight text-[#17201b] dark:text-white">
