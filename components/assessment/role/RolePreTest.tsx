                    ...
                    <div className="bg-brand-light-primary dark:bg-white/5 rounded-2xl p-4 flex flex-col sm:flex-row items-center gap-4 sm:gap-8 border border-brand-light-tertiary dark:border-white/5 mb-6">
                        <div className="flex items-center gap-3 flex-1 w-full sm:w-auto">
                            ...
                            <span className="text-[clamp(11px,0.9vw,14px)] font-medium text-brand-text-light-secondary dark:text-gray-300">
                                Total of <strong className="text-brand-text-light-primary dark:text-white font-bold">20 Questions</strong>
                            </span>
                        </div>
                        ...
                        <div className="flex items-center gap-3 flex-1 w-full sm:w-auto">
                            ...
                            <span className="text-[clamp(11px,0.9vw,14px)] font-medium text-brand-text-light-secondary dark:text-gray-300">
                                Allotted time is <strong className="text-brand-text-light-primary dark:text-white font-bold">30 Minutes</strong>
                            </span>
                        </div>
                    </div>

                    <h4 className="text-brand-text-light-primary dark:text-white font-bold mb-3 text-[clamp(12px,1vw,15px)]">Assessment Structure</h4>
