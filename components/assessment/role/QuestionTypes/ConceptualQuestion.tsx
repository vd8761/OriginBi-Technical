...
const ConceptualQuestionComponent: React.FC<ConceptualQuestionProps> = ({ question, selectedOptionId, onSelectOption }) => {
    return (
        <div className="flex flex-col gap-4">
            {/* Question Text */}
            <div className="bg-white dark:bg-[#1A1D21] border border-brand-light-tertiary dark:border-white/5 p-6 md:p-8 rounded-[20px] shadow-sm transition-colors">
                ...
                <h2 className="text-[clamp(15px,1.5vw,20px)] font-semibold text-brand-text-light-primary dark:text-white leading-relaxed">
                    {question.text}
                </h2>
            </div>
