        ...
        >
          ...
          <div className="relative p-8 sm:p-10 flex flex-col h-full">
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl font-black text-white tracking-tight leading-[0.95] mb-4"
            >
                    ...
                    {done && result ? (
                      <>
                        ...
                        <button
                          ...
                          className="px-5 py-2.5 rounded-xl bg-gray-900 text-white text-sm font-bold hover:bg-gray-800 transition-colors flex items-center gap-2"
                        >
                          Analysis
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 rounded-xl bg-[#1ed36a] text-white text-sm font-black hover:bg-[#17b55a] transition-colors flex items-center gap-2"
                      >
                        <PlayIcon c="w-4 h-4" />
                        Start Now
                      </button>
            ...
            {unpurchasedExams.map((exam, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-lg hover:border-gray-300 transition-all cursor-pointer"
                ...
                >
                  ...
                  <div className="p-6 pl-7">
                    ...
                    {/* Description */}
                    <p className="text-sm text-gray-700 font-medium leading-relaxed mb-4 line-clamp-2">
                      {exam.description}
                    </p>

                    {/* Stats row */}
                    <div className="flex items-center gap-4 text-sm text-gray-700 font-semibold mb-5">
                      <span className="flex items-center gap-1.5">
                        <ClockIcon c="w-4 h-4 text-gray-500" />
                        {exam.duration}
                      </span>
                      <span className="flex items-center gap-1.5">
                    ...
                    {/* Outcome preview */}
                    {detail && (
                      <div className="flex items-start gap-2 p-3 rounded-xl bg-gray-50 mb-5">
                        <TrendUpIcon c="w-4 h-4 text-[#1ed36a] shrink-0 mt-0.5" />
                    ...
                    {/* CTA */}
                    <button className="w-full py-3 rounded-xl bg-gray-900 text-white text-sm font-bold hover:bg-black transition-colors flex items-center justify-center gap-2">
                      Get Started
                      <ChevronRightIcon c="w-4 h-4" />
                    </button>
                  </div>
