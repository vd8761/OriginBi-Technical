...
export class AdminDashboardService {
  ...
  async getSummary(): Promise<DashboardSummaryResponse> {
    ...
    try {
      ...
      // 1. KPIs
      // Question Bank Total (tech assessment related tables)
      ...
      out.kpis.questionBankPluginCount = 5; // Aptitude, Grammar, Coding, MNC, Role

      // Live Sessions & Monitored
      // We need to check across all tech_*_attempts
      ...
      // Flagged (Not implemented in tech tables yet, but keeping structure)
      out.kpis.flaggedToday = 0;
      out.kpis.flaggedAwaitingReview = 0;
      ...
      // 3. Recent Activity (Placeholder as we don't have plugin_decisions for tech yet)
      out.recentActivity = [];

      // 4. Series (Submissions last 7 days)
