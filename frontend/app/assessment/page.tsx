...
function AssessmentPageContent() {
  ...
  return <AssessmentPortal userName={userName} initialView="assessment" />;
}
        ...
        fallback={
          <div className="min-h-screen flex items-center justify-center bg-[#f5fbf7] dark:bg-[#0f1712]">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-sm font-semibold text-slate-600 dark:text-slate-300">Loading library...</p>
            </div>
          </div>
        }
      >
