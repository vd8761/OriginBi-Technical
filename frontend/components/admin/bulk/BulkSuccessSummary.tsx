    ...
    return (
        <div className="flex flex-col h-full w-full items-center justify-center font-sans space-y-8 animate-fade-in py-12">
            <div className="text-center">
                ...
                <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-2">Bulk Registration Completed Successfully</h2>
                <p className="text-black dark:text-white">{success} records have been added successfully</p>
            </div>

            <div 
                style={{ backgroundColor: "var(--admin-bg-soft, #ffffff)" }}
                className="rounded-xl border border-gray-200 dark:border-[#FFFFFF1F] p-8 flex flex-col sm:flex-row gap-8 sm:gap-12 text-center min-w-[500px] justify-center shadow-xl"
            >
                <div className="flex-1">
                    ...
                    <div className="text-xs text-black dark:text-white uppercase font-medium mb-1 tracking-wider">Total records</div>
                ...
                <div className="flex-1">
                    ...
                    <div className="text-xs text-black dark:text-white uppercase font-medium mb-1 tracking-wider">Successfully Registered</div>
                    <div className="text-3xl font-bold text-gray-900 dark:text-white">{success}</div>
                </div>
                <div className="w-px bg-gray-200 dark:bg-gray-700 hidden sm:block"></div>
                <div className="flex-1">
                    <div className="flex justify-center mb-2">
                    ...
                    <div className="text-xs text-black dark:text-white uppercase font-medium mb-1 tracking-wider">Skipped / Issues</div>
                    <div className="text-3xl font-bold text-gray-900 dark:text-white">{skipped}</div>
                </div>
            </div>

            <div className="flex gap-4 pt-4">
                <button onClick={onViewAll} className="px-6 py-2.5 rounded-lg border border-black dark:border-white text-black dark:text-white hover:bg-black/5 dark:hover:bg-white/5 font-medium flex items-center gap-2 transition-colors">
