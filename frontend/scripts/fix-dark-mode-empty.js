const fs = require('fs');
const file = 'c:/Users/Jaya Krishna/Desktop/OriginBi-Technical/frontend/components/student/dashboard/EmptyStateDashboard.tsx';
...
content = content.replace(/bg-white border-b border-gray-200/g, 'bg-white dark:bg-[#111a15] border-b border-gray-200 dark:border-white/10');
content = content.replace(/bg-white border-t border-gray-200/g, 'bg-white dark:bg-[#111a15] border-t border-gray-200 dark:border-white/10');
...
console.log("Done replacing dark mode variants in EmptyStateDashboard.");
